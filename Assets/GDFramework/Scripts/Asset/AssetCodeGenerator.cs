...
namespace YooAsset.Editor
{
    public class AssetCodeGenerator
    {
        ...
        private static List<AssetInfo> ProcessCollector(AssetBundleCollector collector, StringBuilder codeBuilder, string packageName, string groupName)
        {
            ...
            try
            {
                    ...
                    collector.CollectorType == ECollectorType.StaticAssetCollector)
                {
                    ...
                    foreach (var address in addresses)
                    {
                        ...
                        codeBuilder.AppendLine($"               public const string {constantName} = \"{assetAddress}\";");
        ...
        private static void GenerateIDMapping(Dictionary<string, List<AssetInfo>> packageAssets, StringBuilder idMappingBuilder)
        {
            ...
            idMappingBuilder.AppendLine("        {");
            idMappingBuilder.AppendLine("            return IDToAssetPath.TryGetValue(id, out string path) ? path : null;");
            idMappingBuilder.AppendLine("        }");
            ...
            idMappingBuilder.AppendLine("        {");
            idMappingBuilder.AppendLine("            return AssetPathToID.TryGetValue(assetPath, out int id) ? id : -1;");
            idMappingBuilder.AppendLine("        }");
        }
