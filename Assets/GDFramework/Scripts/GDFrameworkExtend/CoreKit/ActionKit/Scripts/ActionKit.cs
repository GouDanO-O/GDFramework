...
")]
        ...
        {
            return GDFrameworkExtend.CoreKit.Delay.Allocate(seconds, callback);
        }
...
")]
        ...
        {
            return GDFrameworkExtend.CoreKit.Sequence.Allocate();
        }
...
")]
        ...
        {
            return GDFrameworkExtend.CoreKit.DelayFrame.Allocate(frameCount, onDelayFinish);
        }

        public static IAction NextFrame(Action onNextFrame)
        {
            return GDFrameworkExtend.CoreKit.DelayFrame.Allocate(1, onNextFrame);
        }


        public static IAction Lerp(float a,float b,float duration,Action<float> onLerp,Action onLerpFinish = null)
        {
            return GDFrameworkExtend.CoreKit.Lerp.Allocate(a, b, duration, onLerp, onLerpFinish);
        }

        public static IAction Callback(Action callback)
        {
            return GDFrameworkExtend.CoreKit.Callback.Allocate(callback);
        }
...
// Right click finished
    ")]
        ...
        {
            return GDFrameworkExtend.CoreKit.Repeat.Allocate(repeatCount);
        }
...
")]
        ...
        {
            return GDFrameworkExtend.CoreKit.Parallel.Allocate();
        }
...
")]
        ...
        {
            var action = GDFrameworkExtend.CoreKit.Custom.Allocate();
        ...
        {
            var action = GDFrameworkExtend.CoreKit.Custom<TData>.Allocate();
            customSetting(action);
            return action;
        }
