...
namespace GDFrameworkExtend.CoreKit
{
    ...
    public static class LerpExtension
    {
        ...
        {
            return self.Append(GDFrameworkExtend.CoreKit.Lerp.Allocate(a,b,duration,onLerp,onLerpFinish));
        }
        
        public static ISequence Lerp01(this ISequence self, float duration,Action<float> onLerp = null,Action onLerpFinish = null)
        {
            return self.Append(GDFrameworkExtend.CoreKit.Lerp.Allocate(0,1,duration,onLerp,onLerpFinish));
        }
