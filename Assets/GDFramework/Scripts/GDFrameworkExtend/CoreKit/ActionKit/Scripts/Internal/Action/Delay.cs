...
namespace GDFrameworkExtend.CoreKit
{
    ...
    public static class DelayExtension
    {
        ...
        {
            return self.Append(GDFrameworkExtend.CoreKit.Delay.Allocate(seconds,onDelayFinish));
        }
        
        public static ISequence Delay(this ISequence self,Func<float> delayTimeFactory,Action onDelayFinish = null)
        {
            return self.Append(GDFrameworkExtend.CoreKit.Delay.Allocate(delayTimeFactory,onDelayFinish));
        }
    }
}