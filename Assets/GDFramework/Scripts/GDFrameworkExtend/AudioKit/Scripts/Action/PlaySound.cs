...
namespace QFramework
{
    public class PlaySoundAction : AbstractAction<PlaySoundAction>
    {
        ...
        public override void OnStart()
        {
            ...
            else if (mMode == Modes.ByClip) AudioKit.PlaySound(mAudioClip, callBack: player => this.Finish());
        }
    ...
    public static class PlaySoundExtension
    {
        ...
        {
            return self.Append(PlaySoundAction.Allocate(soundName));
        }

        public static ISequence PlaySound(this ISequence self, AudioClip clip)
        {
            return self.Append(PlaySoundAction.Allocate(clip));
        }
    }
}