...
")]
        ...
        private static Dictionary<string, int> mSoundFrameCountForName = new();
...
")]
        ...
        public static FluentMusicAPI Music()
        {
            return FluentMusicAPI.Allocate();
        }

        public static FluentSoundAPI Sound()
        {
    ...
    {
        private Stack<IAudioLoader> mPool = new(16);
