...
")]
        ...
        public static T DestroyChildren<T>(this T selfComponent) where T : Component
        {
            ...
            for (var i = childCount - 1; i >= 0; i--) selfComponent.transform.GetChild(i).DestroyGameObjGracefully();
...
")]
        ...
        public static GameObject DestroyChildren(this GameObject selfGameObj)
        {
            ...
            for (var i = childCount - 1; i >= 0; i--) selfGameObj.transform.GetChild(i).DestroyGameObjGracefully();
...
")]
        ...
        public static GameObject Position2D(this GameObject self, float x, float y)
        {
            return self.Position(x, y);
        }

        public static T Position2D<T>(this T self, float x, float y) where T : Component
        {
            return self.Position(x, y);
        }
