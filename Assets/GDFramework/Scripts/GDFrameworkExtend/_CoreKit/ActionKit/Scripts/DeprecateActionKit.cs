...
namespace GDFrameworkExtend._CoreKit.ActionKit
{
    ...
    {
        private Queue<IDeprecateAction> mQueue = new(20);
    ...
    public class ActionKitFSM
    {
        ...
        private Dictionary<Type, ActionKitFSMState> mStates = new();
        private ActionKitFSMTransitionTable mTrasitionTable = new();
    ...
    public class FSM<TStateEnum, TEventEnum> : IDisposable
    {
        ...
        /// </summary>
        private TStateEnum mCurState;

        public TStateEnum State => mCurState;

        /// <summary>
        /// The m state dict.
        /// </summary>
        private Dictionary<TStateEnum, FSMState<TStateEnum>>
            mStateDict = new();
        ...
        public void HandleEvent(TEventEnum name, params object[] param)
        {
            if (mCurState != null && mStateDict[mCurState].TranslationDict.ContainsKey(name))
            {
                ...
                if (mOnStateChanged != null) mOnStateChanged.Invoke(mCurState, tempTranslation.ToState);
    ...
    public class QFSMLite
    {
        ...
        public string State => mCurState;

        /// <summary>
        /// The m state dict.
        /// </summary>
        private Dictionary<string, QFSMState> mStateDict = new();
    ...
    public static class IActionExtension
    {
        ...
        private static WaitForEndOfFrame mEndOfFrame = new();
