...
using GDFramework_Core.Scripts.GDFrameworkExtend._CoreKit.ActionKit.Scripts.Internal;
using GDFramework_Core.Scripts.GDFrameworkExtend._CoreKit.ActionKit.Scripts.Internal.Action;
using QFramework;
...
")]
        ...
        {
            return Internal.Action.Delay.Allocate(seconds, callback);
        }
...
")]
        ...
        {
            return Internal.Action.Sequence.Allocate();
        }
...
")]
        ...
        {
            return Internal.Action.DelayFrame.Allocate(frameCount, onDelayFinish);
        }

        public static IAction NextFrame(Action onNextFrame)
        {
            return Internal.Action.DelayFrame.Allocate(1, onNextFrame);
        }


        public static IAction Lerp(float a, float b, float duration, Action<float> onLerp, Action onLerpFinish = null)
        {
            return Internal.Action.Lerp.Allocate(a, b, duration, onLerp, onLerpFinish);
        }

        public static IAction Callback(Action callback)
        {
            return Internal.Action.Callback.Allocate(callback);
        }
...
// Right click finished
    ")]
        ...
        {
            return Internal.Action.Repeat.Allocate(repeatCount);
        }
...
")]
        ...
        {
            return Internal.Action.Parallel.Allocate();
        }
...
")]
        ...
        {
            var action = Internal.Action.Custom.Allocate();
        ...
        {
            var action = Internal.Action.Custom<TData>.Allocate();
            customSetting(action);
            return action;
        }
