...
namespace GDFramework_Core.Scripts.GDFrameworkExtend._CoreKit.ActionKit.Scripts.Utility
{
    ...
    public class EaseUtility
    {
        ...
        public static float InOutElastic(float start, float end, float pos, float elasticity = 0.3f,
            float duration = 5.0f)
        {
            return pos < 0.5f
        ...
        public static float OutElastic(float start, float end, float pos, float elasticity = 0.3f,
            float duration = 5.0f)
        {
            var distance = end - start;
