...
namespace GDFrameworkExtend._CoreKit.ActionKit
{
    public interface ICustomAPI<TData>
    {
        ...
        ICustomAPI<TData> OnStart(System.Action onStart);
        ICustomAPI<TData> OnExecute(Action<float> onExecute);
        ICustomAPI<TData> OnFinish(System.Action onFinish);
    ...
    internal class Custom<TData> : IAction, ICustomAPI<TData>
    {
        ...
        protected System.Action mOnStart;
        protected Action<float> mOnExecute;
        protected System.Action mOnFinish;

        private static SimpleObjectPool<Custom<TData>> mSimpleObjectPool = new(() => new Custom<TData>(), null, 10);
        ...
        public ICustomAPI<TData> OnStart(System.Action onStart)
        {
            mOnStart = onStart;
            return this;
        }
        ...
        public ICustomAPI<TData> OnFinish(System.Action onFinish)
        {
            mOnFinish = onFinish;
            return this;
        }
    ...
    {
        private static SimpleObjectPool<Custom> mSimpleObjectPool = new(() => new Custom(), null, 10);
