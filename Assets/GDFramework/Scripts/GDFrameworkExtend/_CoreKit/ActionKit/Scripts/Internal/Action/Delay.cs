...
namespace GDFrameworkExtend._CoreKit.ActionKit
{
    ...
    {
        public static ISequence Delay(this ISequence self, float seconds, System.Action onDelayFinish = null)
        {
            return self.Append(Action.Delay.Allocate(seconds, onDelayFinish));
        }

        public static ISequence Delay(this ISequence self, Func<float> delayTimeFactory,
            System.Action onDelayFinish = null)
        {
            return self.Append(Action.Delay.Allocate(delayTimeFactory, onDelayFinish));
        }
    }
}