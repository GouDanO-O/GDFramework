...
namespace GDFrameworkExtend._CoreKit.ActionKit
{
    ...
    public abstract class AbstractAction<T> : IAction where T : AbstractAction<T>, new()
    {
        ...
        private static readonly SimpleObjectPool<T> mPool = new(() => new T(), null, 10);
    ...
    {
        private static SimpleObjectPool<IActionController> mPool = new(
        ...
        public void Deinit()
        {
            if (Action != null && Action.ActionID == ActionID) Action.Deinit();
        }
