...
namespace QFramework
{
    ...
    {
        // 全局的
        private static RenderEndCommandExecutor mGlobal = new();

        private Queue<System.Action> mPrivateCommands = new();

        private Queue<System.Action> mCommands => mPrivateCommands;
