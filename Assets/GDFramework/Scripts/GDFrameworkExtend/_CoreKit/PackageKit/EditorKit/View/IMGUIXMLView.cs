...
namespace QFramework
{
    ...
    {
        private Dictionary<string, IXMLToObjectConverter> mConverters = new();
    ...
    internal class XMLView : VerticalLayout, IXMLView
    {
        ...
        private Lazy<IConvertModule> mConverter = new(() => XMLKit.Get.SystemLayer.Get<IXMLToObjectConvertSystem>()
    ...
    {
        private Dictionary<string, IConvertModule> mModules = new();
    ...
    public class XMLKit
    {
        private static Lazy<XMLKit> mInstance = new(() =>
        {
