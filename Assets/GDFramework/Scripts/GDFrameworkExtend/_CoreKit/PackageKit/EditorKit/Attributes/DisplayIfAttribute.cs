...
namespace QFramework
{
    ...
    public class DisplayIfAttribute : PropertyAttribute
    {
        ...
        public DisplayIfAttribute(params string[] fieldToCheck)
        {
            Data = new DisplayIfData(fieldToCheck);
        }
    ...
    public class DisplayIfData
    {
        ...
        public DisplayIfData(params string[] fieldToCheck)
        {
        ...
        public IEnumerator<(string Field, bool Inverse, string[] CompareAgainst)> GetEnumerator()
        {
            ...
            if (_fieldsToCheckMultiple.IsNotNullAndEmpty())
                for (var i = 0; i < _fieldsToCheckMultiple.Length; i++)
                {
                    ...
                    var withInverseValue = _inverseMultiple != null && _inverseMultiple.Length - 1 >= i;
                    var withCompareValue = _compareValuesMultiple != null && _compareValuesMultiple.Length - 1 >= i;
    ...
    public class ConditionalFieldAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            bool CustomDrawerUsed()
            {
                ...
                {
                    Debug.LogWarning("Unable to use CustomDrawer of type " + _customPropertyDrawer.GetType() + ": " +
                                     e);
        ...
        public static bool IsConditionMatch(UnityEngine.Object owner, DisplayIfData condition)
        {
            ...
            foreach (var fieldCondition in condition)
            {
                ...
                var passed = IsConditionMatch(property, fieldCondition.Inverse, fieldCondition.CompareAgainst);
        ...
        public static bool IsPropertyConditionMatch(SerializedProperty property, DisplayIfData condition)
        {
            ...
            foreach (var fieldCondition in condition)
            {
                ...
                var passed = IsConditionMatch(relativeProperty, fieldCondition.Inverse, fieldCondition.CompareAgainst);
                if (!passed) return false;
            }
        ...
        private static bool IsConditionMatch(SerializedProperty property, bool inverse, string[] compareAgainst)
        {
            ...
            var asString = AsStringValue(property).ToUpper();
