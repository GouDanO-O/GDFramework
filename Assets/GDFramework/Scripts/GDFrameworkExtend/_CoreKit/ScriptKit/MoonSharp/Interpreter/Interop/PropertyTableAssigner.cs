...
namespace MoonSharp.Interpreter.Interop
{
    ...
    {
        private Type m_Type;
        private Dictionary<string, PropertyInfo> m_PropertyMap = new();
        private Dictionary<Type, IPropertyTableAssigner> m_SubAssigners = new();
        ...
        private bool TryAssignProperty(object obj, string name, DynValue value)
        {
            if (m_PropertyMap.ContainsKey(name))
            {
                ...
                if (pi != null)
                {
                    ...
                    {
                        o = Converters.ScriptToClrConversions.DynValueToObjectOfType(value,
