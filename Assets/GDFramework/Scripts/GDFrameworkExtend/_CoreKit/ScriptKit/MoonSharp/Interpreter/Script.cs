...
namespace MoonSharp.Interpreter
{
    ...
    public class Script : IScriptPrivateResource
    {
        ...
        private List<SourceCode> m_Sources = new();
        ...
        public DynValue LoadFunction(string code, Table globalTable = null, string funcFriendlyName = null)
        {
            ...
            var address =
                Loader_Fast.LoadFunction(this, source, m_ByteCode, globalTable != null || m_GlobalTable != null);
        ...
        public DynValue LoadString(string code, Table globalTable = null, string codeFriendlyName = null)
        {
            ...
            var chunkName = string.Format("{0}", codeFriendlyName ?? "chunk_" + m_Sources.Count.ToString());
        ...
        public DynValue LoadStream(Stream stream, Table globalTable = null, string codeFriendlyName = null)
        {
            ...
            {
                var chunkName = string.Format("{0}", codeFriendlyName ?? "dump_" + m_Sources.Count.ToString());
                ...
                bool hasUpvalues;
                var address = m_MainProcessor.Undump(codeStream, m_Sources.Count - 1, globalTable ?? m_GlobalTable,
                    out hasUpvalues);
...
#pragma warning restore 618
            ...
            var code = Options.ScriptLoader.LoadFile(filename, globalContext ?? m_GlobalTable);
        ...
        public DynValue RequireModule(string modname, Table globalContext = null)
        {
            ...
            var globals = globalContext ?? m_GlobalTable;
