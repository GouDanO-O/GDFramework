...
namespace MoonSharp.Interpreter.Loaders
{
    ...
    {
        private Dictionary<string, string> m_Resources = new();
        ...
        private void LoadResourcesUnityNative(string assetsPath)
        {
            try
            {
                var array = UnityEngine.Resources.LoadAll(assetsPath, typeof(UnityEngine.TextAsset));

                for (var i = 0; i < array.Length; i++)
                {
                    var o = (UnityEngine.TextAsset)array[i];
