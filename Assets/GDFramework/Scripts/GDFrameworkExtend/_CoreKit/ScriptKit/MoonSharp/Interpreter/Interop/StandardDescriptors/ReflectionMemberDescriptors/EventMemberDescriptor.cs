...
namespace MoonSharp.Interpreter.Interop
{
    ...
    public class EventMemberDescriptor : IMemberDescriptor
    {
        ...
        private MultiDictionary<object, Closure> m_Callbacks = new(new ReferenceEqualityComparer());
        private Dictionary<object, Delegate> m_Delegates = new(new ReferenceEqualityComparer());
