...
namespace GDFrameworkExtend.ActionKit
{
    ...
    public static class DelayExtension
    {
        ...
        {
            return self.Append(GDFrameworkExtend.ActionKit.Delay.Allocate(seconds,onDelayFinish));
        }
        
        public static ISequence Delay(this ISequence self,Func<float> delayTimeFactory,Action onDelayFinish = null)
        {
            return self.Append(GDFrameworkExtend.ActionKit.Delay.Allocate(delayTimeFactory,onDelayFinish));
        }
    }
}