...
namespace QFramework
{
    public class BundleHotFix : EditorWindow
    {
        ...
        private static string m_HotPath =
            Application.dataPath + "/../Hot/" + EditorUserBuildSettings.activeBuildTarget.ToString();

        private string md5Path = "";
        private string hotCount = "1";
        private OpenFileName m_OpenFileName = null;
        private static Dictionary<string, ABMD5> m_PackedMd5 = new();
