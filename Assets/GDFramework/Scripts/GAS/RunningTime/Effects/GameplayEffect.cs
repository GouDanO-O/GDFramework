...
namespace GDFramework_Core.GAS.RunningTime.Effects
{
    ...
    public class GameplayEffect
    {
        ...
        {
            if (data is null) throw new System.Exception($"GE data can't be null!");
        ...
        private static GrantedAbilityFromEffect[] GetGrantedAbilities(
            IEnumerable<GrantedAbilityConfig> grantedAbilities)
        {
