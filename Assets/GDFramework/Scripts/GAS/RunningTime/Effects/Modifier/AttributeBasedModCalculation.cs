...
namespace GDFramework_Core.GAS.RunningTime.Effects.Modifier
{
    ...
    public class AttributeBasedModCalculation : ModifierMagnitudeCalculation
    {
        ...
        [TabGroup("Default", "AttributeBasedModCalculation")] [EnumToggleButtons] [LabelText("捕获目标(Attribute From)")]
        ...
        [TabGroup("Default", "Details", SdfIconType.Bug, TextColor = "orange")] [ReadOnly]
        public string attributeSetName;

        [TabGroup("Default", "Details")] [ReadOnly]
        ...
        [TabGroup("Default", "AttributeBasedModCalculation")] [LabelText("常量(b)")]
        public float b = 0;
