...
namespace GDFramework.GAS.RunningTime.Effects.Modifier
{
    ...
    public struct GameplayEffectModifier
    {
        ...
        [HideInInspector] public string AttributeSetName;

        [HideInInspector] public string AttributeShortName;
        ...
        [EnumToggleButtons]
        [PropertyOrder(2)]
        [ValidateInput("@ReflectionHelper.GetAttribute(AttributeName).IsSupportOperation($value)",
            "非法运算: 该属性不支持的此运算法则")]
