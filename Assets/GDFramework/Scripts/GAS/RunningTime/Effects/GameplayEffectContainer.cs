...
namespace GDFramework.GAS.RunningTime.Effects
{
    public class GameplayEffectContainer
    {
        ...
        /// </returns>
        public GameplayEffectSpec AddGameplayEffectSpec(AbilitySystemComponent source, GameplayEffectSpec effectSpec,
            bool overwriteEffectLevel = false, int effectLevel = 0)
        {
            ...
            if (effectSpec.Stacking.stackingType == StackingType.AggregateByTarget)
            {
                ...
                if (geSpec == null)
                    return Operation_AddNewGameplayEffectSpec(source, effectSpec, overwriteEffectLevel, effectLevel);
                var stackCountChange = geSpec.RefreshStack();
        ...
        private GameplayEffectSpec Operation_AddNewGameplayEffectSpec(AbilitySystemComponent source,
