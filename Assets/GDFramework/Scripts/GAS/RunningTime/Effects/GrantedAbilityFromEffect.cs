...
namespace GDFramework.GAS.RunningTime.Effects
{
    ...
    public struct GrantedAbilityConfig
    {
        ...
        [LabelWidth(LABEL_WIDTH)] [LabelText(GasTextDefine.LABEL_GRANT_ABILITY)] [AssetSelector]
        public AbilityAsset AbilityAsset;

        [LabelWidth(LABEL_WIDTH)] [LabelText(GasTextDefine.LABEL_GRANT_ABILITY_LEVEL)]
    ...
    public class GrantedAbilitySpecFromEffect
    {
            ...
            GameplayEffectSpec sourceEffectSpec)
        {
            ...
            // 是否添加时激活
            if (ActivationPolicy == GrantedAbilityActivationPolicy.WhenAdded) Owner.TryActivateAbility(AbilityName);
