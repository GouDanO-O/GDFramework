...
namespace GDFramework.GAS.RunningTime.Cue
{
    public class CueVFX : GameplayCueDurational
    {
        ...
        [BoxGroup] [LabelText(GasTextDefine.CUE_VFX_ACTIVE_WHEN_ADDED)]
    ...
    public class CueVFXSpec : GameplayCueDurationalSpec<CueVFX>
    {
        ...
        {
            if (_vfxInstance != null) Object.Destroy(_vfxInstance);
        }

        public override void OnGameplayEffectActivate()
        {
            if (_vfxInstance != null) _vfxInstance.SetActive(true);
        }

        public override void OnGameplayEffectDeactivate()
        {
            if (_vfxInstance != null) _vfxInstance.SetActive(false);
        }
        ...
        {
            if (_vfxInstance != null) _vfxInstance.SetActive(visible);
        }
    }
}