...
namespace GDFramework_Core.GAS.RunningTime.Cue
{
    public sealed class CueAnimationSpeedModifier : GameplayCueDurational
    {
        ...
        [TabGroup("Data", "Data")] [LabelText("播放速度")] [LabelWidth(LabelWidth)] [Range(0, 5f)]
    ...
    public sealed class GCS_ChangeAnimationSpeed : GameplayCueDurationalSpec<CueAnimationSpeedModifier>
    {
        ...
        {
            if (_animator != null) _animator.speed = cue.speed;
        }

        public override void OnGameplayEffectDeactivate()
        {
            if (_animator != null) _animator.speed = cue.defaultSpeed;
        }
