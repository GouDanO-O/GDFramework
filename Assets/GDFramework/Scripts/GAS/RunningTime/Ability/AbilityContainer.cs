...
namespace GDFramework_Core.GAS.RunningTime.Ability
{
    public class AbilityContainer
    {
        ...
        public void Tick()
        {
            ...
            foreach (var abilitySpec in _cachedAbilities) abilitySpec.Tick();
        ...
        public bool TryActivateAbility(string abilityName, params object[] args)
        {
            ...
            foreach (var kv in _abilities)
            {
                ...
                if (abilityTag.AssetTag.HasAnyTags(tags)) _abilities[kv.Key].TryCancelAbility();
            }
        ...
        private void CancelAbilitiesByTag(GameplayTagSet tags)
        {
            foreach (var kv in _abilities)
            {
                var abilityTag = kv.Value.Ability.Tag;
        ...
        public Dictionary<string, AbilitySpec> AbilitySpecs()
        {
            return _abilities;
        }
        ...
        public bool HasAbility(AbstractAbility ability)
        {
            return HasAbility(ability.Name);
        }
    }
}