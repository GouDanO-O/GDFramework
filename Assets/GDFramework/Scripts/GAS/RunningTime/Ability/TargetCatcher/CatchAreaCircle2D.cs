    ...
    public sealed class CatchAreaCircle2D : CatchAreaBase
    {
            ...
            List<AbilitySystemComponent> results)
        {
            var count = centerType switch
            {
                ...
                EffectCenterType.TargetOffset => mainTarget.OverlapCircle2DNonAlloc(offset, radius, Collider2Ds,
                    checkLayer),
                _ => 0
            };
            ...
            for (var i = 0; i < count; ++i)
            {
                ...
                if (targetUnit != null) results.Add(targetUnit);
            }
        }
#if UNITY_EDITOR
