...
namespace GDFramework_Core.GAS.RunningTime.Component
{
    ...
    public class AbilitySystemComponent : MonoBehaviour, IAbilitySystemComponent
    {
        ...
        {
            Prepare();
            GameplayAbilitySystem.Instance.RegisterAbilitySystemComponent(this);
        ...
        {
            Disable();
            GameplayAbilitySystem.Instance.UnregisterAbilitySystemComponent(this);
        }
...
#pragma warning restore CS0168 // 声明了变量，但从未使用过
        ...
        public void ApplyModFromInstantGameplayEffect(GameplayEffectSpec spec)
        {
            foreach (var modifier in spec.Modifiers)
            {
                ...
                AttributeSetContainer.AttributeSetDict[modifier.AttributeSetName]
