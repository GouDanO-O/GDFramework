...
namespace GDFramework_Core.GAS.General.Util
{
    public static class DebugExtension
    {
        ...
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DebugDrawCircle(Vector2 center, float radius, Color color, float showTime,
            float segments = 120)
        {
        ...
        /// <param name="duration">绘制时长(0为1帧)</param>
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawArc(in Vector3 position, in Quaternion rotation, float radius, float angle,
            int segments = 12,
            in Color? color = null, float duration = 0f)
        {
            if (angle <= 0) return;
        ...
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawArc(in Vector3 position, in Vector3 forward, float radius, float angle,
            int segments = 12,
            in Color? color = null, float duration = 0f)
        {
        ...
        /// <param name="duration">绘制时长(0为1帧)</param>
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawRing(in Vector3 position, in Quaternion rotation, float outerRadius, float innerRadius,
            int segments = 36,
            in Color? color = null, float duration = 0f)
        {
            ...
            for (var i = 1; i <= segments; i++)
            {
                ...
                var nextOuterPoint =
                    position + rotation * (Quaternion.Euler(0, angle, 0) * Vector3.right * outerRadius);
                var nextInnerPoint =
                    position + rotation * (Quaternion.Euler(0, angle, 0) * Vector3.right * innerRadius);
        ...
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawRing(in Vector3 position, in Vector3 forward, float outerRadius, float innerRadius,
            int segments = 36,
            in Color? color = null, float duration = 0f)
        {
            ...
            in Color? color = null, float duration = 0f)
        {
            ...
            // 旋转角点并转换到世界坐标系
            for (var i = 0; i < corners.Length; i++) corners[i] = position + rotation * corners[i];
            ...
            in Color? color = null, float duration = 0f)
        {
            ...
            // 旋转顶点并转换到世界坐标系
            for (var i = 0; i < vertices.Length; i++) vertices[i] = position + rotation * vertices[i];
        ...
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawCylinder(in Vector3 position, in Quaternion rotation, float radius, float height,
            int segments = 12,
            in Color? color = null, float duration = 0f)
        {
        ...
        /// <param name="duration"></param>
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawCylinder(in Vector3 position, in Vector3 forward, float radius, float height,
            int segments = 12,
            in Color? color = null, float duration = 0f)
        {
            ...
            in Color? color = null, float duration = 0f)
        {
            ...
            if (forward == Vector3.zero) forward = Vector3.Cross(direction, Vector3.right).normalized;
        ...
        /// <param name="duration">绘制时长(0为1帧)</param>
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawSector(Vector3 position, Quaternion rotation, float radius, float angle,
            int segments = 12,
        ...
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawSector(in Vector3 position, in Vector3 forward, float radius, float angle,
            int segments = 12,
            in Color? color = null, float duration = 0f)
        {
        ...
        /// <param name="duration">绘制时长(0为1帧)</param>
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawAnnularSector(in Vector3 position, in Quaternion rotation, float outerRadius,
            float innerRadius, float angle, int segments = 12,
            in Color? color = null, float duration = 0f)
        {
            if (outerRadius <= 0) return;
            if (segments <= 0) return;
        ...
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawAnnularSector(in Vector3 position, in Vector3 forward, float outerRadius,
            float innerRadius, float angle, int segments = 12, in Color? color = null, float duration = 0f)
        {
            DrawAnnularSector(position, Quaternion.LookRotation(forward), outerRadius, innerRadius, angle, segments,
                color, duration);
        }
        ...
        /// <param name="duration">绘制时长(0为1帧)</param>
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawArrow(in Vector3 origin, in Vector3 destination, in Color? color = null,
            float duration = 0f)
        {
        ...
        /// <param name="duration">绘制时长(0为1帧)</param>
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawArrow(in Vector3 origin, in Quaternion rotation, float length, in Color? color = null,
            float duration = 0f)
        {
        ...
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public static void DrawArrow(in Vector3 origin, in Vector3 direction, float length, in Color? color = null,
            float duration = 0f)
        {
