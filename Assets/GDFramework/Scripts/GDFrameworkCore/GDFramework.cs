...
namespace GDFramework_Core.Scripts.GDFrameworkCore
{
    #region Architecture
    ...
    public abstract class Architecture<T> : IArchitecture where T : Architecture<T>, new()
    {
        ...
        private IOCContainer mContainer = new();
    ...
    public interface IController : IBelongToArchitecture, ICanSendCommand,
    ...
    public static class UnRegisterExtension
    {
        ...
        private static T GetOrAddComponent<T>(GameObject gameObject) where T : Component
        {
            ...
            if (!trigger) trigger = gameObject.AddComponent<T>();
        ...
        public static IUnRegister UnRegisterWhenGameObjectDestroyed<T>(this IUnRegister self,
            T component)
            where T : Component
        {
    ...
    public class BindableProperty<T> : IBindableProperty<T>
    {
        ...
        private EasyEvent<T> mOnValueChanged = new();
