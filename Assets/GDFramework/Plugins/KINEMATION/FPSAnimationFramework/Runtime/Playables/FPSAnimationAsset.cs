...
namespace KINEMATION.FPSAnimationFramework.Runtime.Playables
{
    ...
    {
        [Tooltip("Target rig asset.")] public KRig rigAsset;

        [Header("Animation")] [Tooltip("Select your animation.")]
        ...
        [Header("Blend In/Out")] [Tooltip("Smooth blend in/out parameters.")]
        public BlendTime blendTime = new(0.15f, 0.15f);
