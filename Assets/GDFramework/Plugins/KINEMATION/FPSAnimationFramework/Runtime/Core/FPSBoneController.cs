...
namespace KINEMATION.FPSAnimationFramework.Runtime.Core
{
    ...
    public class FPSBoneController : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            if (_rigComponent == null) Debug.LogError("FPSAnimatorBoneController: no RigComponent found!");
        }

        public virtual void GameThreadUpdate()
        {
            foreach (var state in _layerStates) state.OnGameThreadUpdate();
        }
        ...
        public virtual void CachePose()
        {
            ...
            {
                var reference = _rigComponent.GetRigTransform(index);
        ...
        public virtual void EvaluatePose()
        {
            ...
            foreach (var state in _layerStates) state.OnPreEvaluatePose();
        ...
        {
            // Apply the active animator states.
            foreach (var state in _layerStates) state.OnPostEvaluatedPose();
        }
