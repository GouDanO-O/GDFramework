...
namespace KINEMATION.FPSAnimationFramework.Runtime.Recoil
{
    ...
    {
        [Tab("Recoil Targets")] [Header("Rotation Targets")]
        public Vector2 pitch;

        public Vector4 roll = new(0f, 0f, 0f, 0f);
        public Vector4 yaw = new(0f, 0f, 0f, 0f);

        [Header("Translation Targets")] public Vector2 kickback;
        public Vector2 kickUp;
        public Vector2 kickRight;

        [Header("Aiming Multipliers")] public Vector3 aimRot;
        public Vector3 aimLoc;

        [Tab("Smoothing")] [Header("Auto/Burst Settings")]
        ...
        [Header("Pushback Layer")] public float pushAmount = 0f;
        public float pushAccel;
        public float pushDamp;

        [Tab("Misc")] public Vector3 hipPivotOffset;
        public Vector3 aimPivotOffset;
        public bool smoothRoll;
        public float playRate;

        [Header("Recoil Curves")] public RecoilCurves recoilCurves = new(
