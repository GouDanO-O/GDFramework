...
namespace KINEMATION.FPSAnimationFramework.Runtime.Layers.PoseSamplerLayer
{
    ...
    {
        [Header("General")] public FPSAnimationAsset poseToSample;
        ...
        [Header("IK Targets")] public KRigElement ikWeaponBone = new(-1, FPSANames.IkWeaponBone);
        public KRigElement ikHandRight = new(-1, FPSANames.IkRightHand);
        public KRigElement ikHandLeft = new(-1, FPSANames.IkLeftHand);

        public KRigElement ikHandRightHint = new(-1, FPSANames.IkRightElbow);
        public KRigElement ikHandLeftHint = new(-1, FPSANames.IkLeftElbow);

        [Header("Weapon Bone")] public KRigElement weaponBoneRight = new(-1, FPSANames.IkWeaponBoneRight);
        public KRigElement weaponBoneLeft = new(-1, FPSANames.IkWeaponBoneLeft);
        public KRigElement weaponBone = new(-1, FPSANames.WeaponBone);

        [Header("Spine")] public KRigElement pelvis;
        public KRigElement spineRoot;

        [Header("Input Properties")] [CurveSelector(false, false)]
        public string stabilizationWeight = FPSANames.StabilizationWeight;

        [CurveSelector(false, true, false)] public string weaponBoneWeight = FPSANames.Curve_WeaponBoneWeight;
