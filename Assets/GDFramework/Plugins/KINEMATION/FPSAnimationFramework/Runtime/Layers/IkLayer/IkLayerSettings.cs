...
namespace KINEMATION.FPSAnimationFramework.Runtime.Layers.IkLayer
{
    ...
    {
        [Header("Hands IK")] public KRigElement rightHand;
        public KRigElement leftHand;

        public KRigElement rightHandIk = new(-1, FPSANames.IkRightHand);
        public KRigElement leftHandIk = new(-1, FPSANames.IkLeftHand);

        public KRigElement rightHandHint = new(-1, FPSANames.IkRightElbow);
        public KRigElement leftHandHint = new(-1, FPSANames.IkLeftElbow);

        [Header("Foot IK")] public KRigElement rightFoot;
        public KRigElement leftFoot;

        public KRigElement rightFootIk = new(-1, FPSANames.IkRightFoot);
        public KRigElement leftFootIk = new(-1, FPSANames.IkLeftFoot);

        public KRigElement rightFootHint = new(-1, FPSANames.IkRightKnee);
        public KRigElement leftFootHint = new(-1, FPSANames.IkLeftKnee);
