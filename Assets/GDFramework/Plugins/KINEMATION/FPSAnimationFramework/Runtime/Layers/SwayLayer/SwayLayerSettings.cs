...
namespace KINEMATION.FPSAnimationFramework.Runtime.Layers.SwayLayer
{
    ...
    public struct VectorSpring
    {
        ...
        public static VectorSpring Identity = new()
        {
            damping = Vector3.one,
    ...
    {
        [Header("Free Aiming")] public KRigElement headBone;
        public float freeAimClamp;
        public float freeAimInterpSpeed;
        public float freeAimInputScale;
        public ESpaceType freeAimSpace;

        [InputProperty] public string useFreeAimProperty = FPSANames.UseFreeAim;

        [Header("Move Sway")] public VectorSpring moveSwayPositionSpring = VectorSpring.Identity;
        ...
        [InputProperty] public string moveInputProperty = FPSANames.MoveInput;

        [Header("Aim Sway")] public VectorSpring aimSwayPositionSpring = VectorSpring.Identity;
