...
namespace KINEMATION.KAnimationCore.Runtime.Rig
{
    ...
    public class KRig : ScriptableObject
    {
        ...
        public List<KRigElement> rigHierarchy = new();
        public List<KRigElementChain> rigElementChains = new();
        public List<string> rigCurves = new();
        ...
        {
            var result = new KTransformChain();
...
#if UNITY_EDITOR
        public List<int> rigDepths = new();
        private List<Object> _rigObservers = new();
        ...
        public void RegisterRigObserver(Object newRigObserver)
        {
            ...
            var observer = (IRigObserver)newRigObserver;
            if (observer == null) return;

            if (_rigObservers.Contains(newRigObserver)) return;
        ...
        {
            var validObservers = new List<Object>();
