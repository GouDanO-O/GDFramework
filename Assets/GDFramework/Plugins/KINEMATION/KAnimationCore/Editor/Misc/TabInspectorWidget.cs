...
namespace KINEMATION.KAnimationCore.Editor.Misc
{
    ...
    public class TabInspectorWidget : IEditorTool
    {
        ...
        private T[] GetPropertyAttributes<T>(SerializedProperty property) where T : System.Attribute
        {
            ...
            var fieldInfo = _serializedObject.targetObject.GetType().GetField(property.propertyPath,
                BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
            if (fieldInfo != null) output = (T[])fieldInfo.GetCustomAttributes(typeof(T), true);
        ...
        public void Init()
        {
            ...
            {
                var tabAttributes = GetPropertyAttributes<TabAttribute>(property);
        ...
        public void Render()
        {
            ...
            foreach (var defaultProperty in _defaultProperties) EditorGUILayout.PropertyField(defaultProperty, true);
