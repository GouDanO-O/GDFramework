    ...
    public class AssetObjectWidget<T> where T : Object
    {
        ...
        public void OnInspectorGUI()
        {
            ...
            if (EditorUtility.IsPersistent(_parentAsset))
            {
                ...
                var objectRef = _targetProperty.objectReferenceValue;
                ...
                if (GUILayout.Button("Create")) OnCreatePressed();
                ...
                {
                    if (!IsSubAsset(_targetProperty.objectReferenceValue)) DestroyObject(_cachedObject, false);
