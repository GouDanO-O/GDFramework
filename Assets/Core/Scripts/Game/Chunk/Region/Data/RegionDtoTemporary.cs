...
namespace Core.Game.Chunk.Region.Data
{
    ...
    public class RegionDtoTemporary  : ChunkDtoTemporary
    {
        ...
        [ShowIf("playerIsLocateThisAreaBlock"),LabelText("当前玩家所处的区块的副本ID")]
        public string curPlayerLocateStrongholdId;
        ...
        public void UpdateCurPlayerLocateStrongholdId(string curStrongholdId)
        {
