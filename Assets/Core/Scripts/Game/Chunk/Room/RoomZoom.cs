...
namespace Core.Game.Chunk.Room
{
    ...
    public class RoomZoom
    {
        ...
        public void InitRoomZoom(RoomManager roomManager,float zoomScaleRatio,Vector2 zoomScaleArea)
        {
        ...
        public void HandleMouseMiddleScroll(float curValue)
        {
            ...
            roomManager.ChangeContentRectLoaclScale(Vector3.one * _curZoomScale);
        }
    }
}