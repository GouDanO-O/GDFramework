...
namespace GDFramework_Core.GAS.RunningTime.Ability.TimelineAbility.TrackItem
{
    ...
    public class ReleaseGameplayEffectMarkEvent : MarkEventBase
    {
        ...
        {
            Type = typeof(GDFramework_Core.GAS.RunningTime.Ability.TargetCatcher.CatchSelf).FullName // 默认 CatchSelf
        };

        public List<GameplayEffectAsset> gameplayEffectAssets = new List<GameplayEffectAsset>();


        private GDFramework_Core.GAS.RunningTime.Ability.TargetCatcher.TargetCatcherBase _targetCatcher;
        public GDFramework_Core.GAS.RunningTime.Ability.TargetCatcher.TargetCatcherBase TargetCatcher
        {
            get
            {
        ...
        public void SaveTargetCatcher(GDFramework_Core.GAS.RunningTime.Ability.TargetCatcher.TargetCatcherBase targetCatcher)
        {
        ...
        public GDFramework_Core.GAS.RunningTime.Ability.TargetCatcher.TargetCatcherBase LoadTargetCatcher()
        {
            GDFramework_Core.GAS.RunningTime.Ability.TargetCatcher.TargetCatcherBase targetCatcher = null;
            ...
            else
            {
                ...
                {
                    targetCatcher = Activator.CreateInstance(type) as GDFramework_Core.GAS.RunningTime.Ability.TargetCatcher.TargetCatcherBase;
                }
                else
                {
                    targetCatcher = JsonUtility.FromJson(jsonData, type) as GDFramework_Core.GAS.RunningTime.Ability.TargetCatcher.TargetCatcherBase;
                }
            }
        ...
        public static Type[] TargetCatcherSonTypes =>
            _targetCatcherSonTypes ??= TypeUtil.GetAllSonTypesOf(typeof(GDFramework_Core.GAS.RunningTime.Ability.TargetCatcher.TargetCatcherBase));
