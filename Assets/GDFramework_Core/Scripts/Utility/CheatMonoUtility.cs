...
namespace GDFramework_Core.Utility
{
    public class CheatMonoUtility : BasicToolMonoUtility,ICanGetModel
    {
        ...
        protected override void DrawGUI()
        {
            ...
            Dictionary<string,AddCheatCommand> cheaters = _cheatDataModel.GetCheaterDatas();
            foreach (var cheat in cheaters)
            {
                GUILayout.BeginHorizontal();

                AddCheatCommand thisCommand = cheat.Value;
                ...
                {
                    AddFreeVideoCheatCommand newCommand= (AddFreeVideoCheatCommand)thisCommand;
